          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <a className="btn text-white bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="https://forms.gle/QibFqbEmnA3uU7KE9">REGISTER</a>
                </div>
                <div>
                  <a className="btn text-white bg-red-900 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="https://forms.gle/oqPys2jHZw3ub2JN7">HACK</a>
                </div>
              </div>
            </div>
          </div>
