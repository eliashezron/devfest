      ...
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className='text-slate-500 inline-flex'><Link className="font-medium hover:underline text-slate-50" href="https://lu.ma/veliqhyg" target="_blank" rel="noreferrer">HACK<span className="hidden sm:inline"> To win</span></Link> <span className="italic px-1.5">or</span> <Link className="font-medium hover:underline text-emerald-400" href="https://forms.gle/byKQ6uF5LEwM4qcE9" target="_blank" rel="noreferrer">Apply as a Speaker</Link></div>
