...
import motiv from '@/public/images/motiv.jpeg'
import binusu from '@/public/images/binusu.png'
import iv from '@/public/images/iv.png'
import muda from '@/public/images/muda.png'
import wc from '@/public/images/wc.jpeg'
import ngeni from '@/public/images/ngeni.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
            ...
            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <Image src={binusu} width={100} height={100} alt="Celo" />
            </div>

            {/* Item */}
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
            <Image src={wc} width={100} height={100} alt="Celo" />
            </div>
